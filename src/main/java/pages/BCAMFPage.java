...
public class BCAMFPage{
	
	 
	
	// Initialize the Page objects using driver having capabilities
	public BCAMFPage(AppiumDriver driver)
	{
		PageFactory.initElements(new AppiumFieldDecorator(driver),BCAMFPage.class);
		
	}
	

	private static String CustDistance="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'Customer distance to nearest branch(km)*')]/parent::android.view.ViewGroup/following-sibling::android.view.ViewGroup[@index='1']";
	
	private static String CustDistanceVal="//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'0-50')]/parent::android.view.ViewGroup";
	...
	public static String getCustDistance()
	{
		System.out.println("trying to find the CustDistance in dropdown");
		return CustDistance;
		
		
	}
	
	public static AndroidElement getCustDistanceVal(String CustDistanceVal, AndroidDriver<AndroidElement> driver)
	{
		
		return setCustDistanceVal(CustDistanceVal,driver);
		
	}
	
	public static AndroidElement setCustDistanceVal(String CustDistanceVal, AndroidDriver<AndroidElement> driver)
	{
		
		return driver.findElementByXPath("//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'"+CustDistanceVal+"')]/parent::android.view.ViewGroup");
	}
