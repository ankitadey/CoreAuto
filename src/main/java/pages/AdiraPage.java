...
public class AdiraPage{
	...
	public static AndroidElement getExistingCustVal(String ExistingCustVal, AndroidDriver<AndroidElement> driver)
	{
		
		return setExistingCustVal(ExistingCustVal,driver);
		
	}
	
	public static AndroidElement setExistingCustVal(String ExistingCustVal, AndroidDriver<AndroidElement> driver)
	{
		return driver.findElementByXPath("//android.widget.FrameLayout[@index=0]//android.view.ViewGroup[@index='6']//android.widget.ScrollView[@index='0']//android.widget.TextView[contains(@text,'"+ExistingCustVal+"')]/parent::android.view.ViewGroup");
