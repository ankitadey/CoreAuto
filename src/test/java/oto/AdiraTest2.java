...
public class AdiraTest2  {
	...
	@Test(priority=3)
	public void addAdiraFormBasicDetails() throws InterruptedException, IOException
	{
		
	      
		
		
		System.out.println("ExistingCustVal:"+DashboardTest.ExistingCustVal);
		...
		AdiraPage.getExistingCustVal(DashboardTest.ExistingCustVal,DashboardTest.driver1).click();
		Thread.sleep(4000);
